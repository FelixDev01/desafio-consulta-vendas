...
public class SaleService {
	...
	public Page<SaleSummaryDTO> summary(String minDate, String maxDate, String name, Pageable pageable) {
		...
		return repository.searchSalesSummary(min, max, name, pageable);
	}
}
